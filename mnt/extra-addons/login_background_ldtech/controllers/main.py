...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if style == 'default' or style is False:
            ...
            response = request.render('login_background_ldtech.left_login_template', values)
        elif style == 'right':
            response = request.render('login_background_ldtech.right_login_template', values)
        else:
            response = request.render('login_background_ldtech.middle_login_template', values)
